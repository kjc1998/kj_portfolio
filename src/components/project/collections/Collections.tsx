			...
			<div className="h-32 sm:h-24 mb-4 overflow-y-auto scrollbar-hide">
				<div className="h-full flex flex-wrap content-start justify-center sm:justify-start gap-2">
					{project.tags.map((tag, i) => (
						<span
							key={i}
							className="h-8 px-3 py-1 text-sm rounded-full bg-gray-800 text-gray-400 border border-gray-700/50 group-hover:border-gray-600/50 group-hover:text-gray-300 transition-colors whitespace-nowrap"
						>
